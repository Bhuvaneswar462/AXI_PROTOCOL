...
REM
REM Generated by Vivado on Wed Jan 07 11:19:17 +0530 2026
...
echo "xvlog --incr --relax -prj tb_axi4_master_vlog.prj"
call xvlog  --incr --relax -prj tb_axi4_master_vlog.prj -log xvlog.log
